...
const ConvoDisplay = (props) => {
  ...
  useEffect(() => {
    ...
    if(scenarioData.unhealthyConvo !== '' || scenarioData.healthyConvo !== '') {
      
      const unhealthyConversation = JSON.parse(scenarioData.unhealthyConvo)
      const healthyConversation = JSON.parse(scenarioData.healthyConvo)

      setPreviewData({
        title,
        description,
        category: '',
        unhealthyConvo: unhealthyConversation,
        healthyConvo: healthyConversation
      })
    }
    ...
    <>
      ...
      <div className="grid grid-cols-2 divide-x divide-slate-300 border border-slate-200 p-10 rounded-md">
        <div className="col-span-1 px-6">
          ...
          <ul>
            {previewData.unhealthyConvo.convo.map((message) => {
          ...
          <div className="text-sm">
            ...
            <ul className="list-disc pl-5">
              {previewData.unhealthyConvo.breakdown.points.map((point) => {
                return (
                  <>
                    <li className="my-2">
        ...
        <div className="col-span-1 px-6">
          ...
          <ul>
            {previewData.healthyConvo.convo.map((message) => {
              if (message.name === "David") {
                return (
                  <>
                    <li className="my-2">
          ...
          <div className="text-sm">
            ...
            <ul className="list-disc pl-5">
              {previewData.healthyConvo.breakdown.points.map((point) => {
                return (
                  <>
                    <li className="my-2">
                      <strong>{point.pointTitle}: </strong>
